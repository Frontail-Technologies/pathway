...
import { MobileCollegeFilters } from './mobile-college-filters'
...
type CollegeResultsToolbarProps = {
  resultCount: number
  filters: FilterState
...
export function CollegeResultsToolbar({
  resultCount,
  filters,
  ...
  return (
    <div className="mb-4">
      ...
      <MobileCollegeFilters open={sheetOpen} onOpenChange={setSheetOpen} filters={filters} onApply={onApplyMobileFilters} />
    </div>
  )
}
